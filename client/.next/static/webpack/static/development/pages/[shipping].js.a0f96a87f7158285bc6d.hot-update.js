...
var getCart = function getCart(data) {
  return function (dispatch) {
    _Types__WEBPACK_IMPORTED_MODULE_0__["defaultAxios"].get("/venders/".concat(req), data).then(function (res) {
      return dispatch({
        type: _Types__WEBPACK_IMPORTED_MODULE_0__["Post_Add"],
        payload: data
      });
...
//# sourceMappingURL=[shipping].js.a0f96a87f7158285bc6d.hot-update.js.map