...
var getCart = function getCart(data) {
  return function (dispatch) {
    _Types__WEBPACK_IMPORTED_MODULE_0__["defaultAxios"].get("/venders/Addresses", data).then(function (res) {
      return dispatch({
        type: _Types__WEBPACK_IMPORTED_MODULE_0__["Post_Add"],
        payload: data
      });
...
//# sourceMappingURL=[shipping].js.b368b2fa7a04f755bb1a.hot-update.js.map