...
var getCart = function getCart(data) {
  return function (dispatch) {
    _Types__WEBPACK_IMPORTED_MODULE_0__["defaultAxios"].get("/venders/", data).then(function (res) {
      return dispatch({
        type: _Types__WEBPACK_IMPORTED_MODULE_0__["Post_Add"],
        payload: data
      });
...
//# sourceMappingURL=[shipping].js.c363af78281f71d9495d.hot-update.js.map