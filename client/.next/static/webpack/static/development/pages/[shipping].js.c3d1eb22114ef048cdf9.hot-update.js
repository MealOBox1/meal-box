...
var getCart = function getCart(data) {
  return function (dispatch) {
    _Types__WEBPACK_IMPORTED_MODULE_0__["defaultAxios"].get("/venders/".concat(req.params.id), data).then(function (res) {
      return dispatch({
        type: _Types__WEBPACK_IMPORTED_MODULE_0__["Post_Add"],
        payload: data
      });
...
//# sourceMappingURL=[shipping].js.c3d1eb22114ef048cdf9.hot-update.js.map